...
try {
    $blockedSites = @(
        ...
        "voicechanger.easeus.com",
        "memesoundboard.fun",
        "usesounds.com",
        "mixkit.co",
        "film.imyfone.com",
        "portaldosmemes.com.br",
        "soundinstants.com",
        ...
        "fnafgames.io",
        "babyyellow.io",
        "squidgameunleashed.com",
        "dinorunner.com",
        "polybuzz.ai",
        "flappybird.io",
        "flappy-bird.uk",
        "flappybird.org",
        "poly-bus.firstory.io",
        "fab.com",
        "friv-2026.com",
        "frivclassic.com",
        "friv.vip",
